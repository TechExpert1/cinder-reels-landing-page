  ...
  return (
    <div className="bg-black text-white md:py-[0px] py-[30px] px-[20px] md:px-[50px]">
      <div className="max-w-sm md:max-w-6xl mx-auto">
        <h2 className="text-[24px] md:text-[40px] font-bold font-['Montserrat'] text-center mb-[24px] md:mb-[50px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mb-[25px] md:mb-[50px] ">
          {signupSteps.map((step, index) => (
            <div key={index} className="bg-[#1E1E1E] hover:bg-[#78808A] hover:border-[#4A90E2] border-[#2E2E2E] border-[1px] rounded-[20px] py-[24px] px-[14px] md:py-8 md:px-8 transition-colors">
              ...
              <h3 className="text-[18px] md:text-[24px] font-bold font-['Montserrat'] mb-4">{step.title}</h3>
              <p className="font-['Montserrat'] text-[14px] md:text-[18px] leading-loose">{step.description}</p>
            </div>
          ))}
        </div>
        
        <div className="text-center md:max-w-[750px] mx-auto">
          <p className="text-[18px] leading-[32px] font-semibold font-['Montserrat'] md:text-[30px] md:leading-[60px] ">
